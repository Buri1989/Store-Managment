...
import { Button, Snackbar, useScrollTrigger } from '@mui/material';
import DeleteIcon from '@mui/icons-material/Delete';
import UpdateIcon from '@mui/icons-material/Update';
import products, { deleteProduct, updateProduct } from '../../../redux/reduxSlice/products/products'

const MyFormHelperText = (text) => {
...
const EditProductFormComp = ({ product }) => {
    ...
    return (
        <Box component='form' sx={{
            ...
            <FormControl sx={{ width: '25ch' }}>
                <OutlinedInput value={ID} onChange={(event) => {
            ...
            <Button variant='contained' sx={{ padding: 2 }}
                endIcon={<UpdateIcon />} color={"success"} onClick={handleUpdate}>Update</Button>
            <Button variant='contained' sx={{ padding: 2 }}
                startIcon={<DeleteIcon />} color={"error"} onClick={handleDelete} >Delete</Button>
